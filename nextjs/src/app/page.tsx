	...
	return (
		<div className='section'>
			<p className='max-w-xl mt-8 mb-6 text-lg leading-loose'>
				...
				. You may navigate to and view all the pages of this web app, but
				only I am able to complete the create, update, and delete operations
				upon logging in with my admin credentials.
			</p>
		</div>
	)
}
